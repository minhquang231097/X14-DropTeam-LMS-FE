  ...
  return (
    <div className='changepassword-container'>
      ...
      >
        ...
        >
          <Input.Password type='password' onChange={(event) => setChangePasswordValue({ ...changePasswordValue, password: event.target.value })} />
        </Form.Item>
        ...
        <Form.Item
          ...
          hasFeedback
        >
          <Input.Password type='password' onChange={(e)=>setChangePasswordValue({...changePasswordValue, newPassword:e.target.value})}/>
        </Form.Item>
