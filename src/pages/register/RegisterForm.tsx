import { Button, Checkbox, Form, Input, Select, DatePicker, ConfigProvider } from 'antd'
...
const RegisterForm: React.FC = () => {
  ...
  return (
    <ConfigProvider theme={{ components: { Input: { colorFillAlter: mode === 'light' ? '#e5e7eb' : '#111827' } } }}>
      <div className='mt-4'>
        <Form
          name='register'
          className='mt-4'
        ...
        >
          <div className='grid grid-cols-2 gap-3'>
            ...
            <Form.Item
              ...
              hasFeedback
              label={<p className='my-2 font-bold text-black'>Full Name</p>}
            >
              <Input
                size='large'
                type='text'
            ...
            <Form.Item
              name='dob'
              label={<p className='my-2 font-bold text-black'>Date of Birth</p>}
            ...
            <Form.Item
              ...
              label={<p className='my-2 font-bold text-black'>Gender</p>}
              hasFeedback
            >
              <Select
                size='large'
            ...
            <Form.Item
              name='phone'
              label={<p className='my-2 font-bold text-black'>Phone number</p>}
              hasFeedback
              rules={[
            ...
            <Form.Item
              ...
              label={<p className='my-2 font-bold text-black'>Address</p>}
              hasFeedback
            >
              <Input
                size='large'
            ...
            <Form.Item
              name='email'
              label={<p className='my-2 font-bold text-black'>Email</p>}
              hasFeedback
              rules={[
                {
                  type: 'email',
          ...
          <Form.Item
            name='username'
            label={<p className='my-2 font-bold text-black'>Username</p>}
            hasFeedback
            rules={[
          ...
          <div className='grid grid-cols-2 gap-3'>
            ...
            <Form.Item
              ...
              hasFeedback
              label={<p className='my-2 font-bold text-black'>Password</p>}
            >
              <Input.Password
                size='large'
                placeholder='********'
            ...
            <Form.Item
              ...
              hasFeedback
              label={<p className='my-2 font-bold text-black'>Confirm Password</p>}
              rules={[
                {
                  required: true,
